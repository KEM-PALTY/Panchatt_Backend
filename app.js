...
app.post("/updateyt",isLoggedIn, async (req,res)=>{
  count=0;
 go(`https://youtube.googleapis.com/youtube/v3/playlists?key=AIzaSyCosfJ22WXpYAvaiSP62ER9TolvFEPOaLc&channelId=UCvjgXvBlbQiydffZU7m1_aw&part=snippet`);
...
if(gg.nextPageToken!=undefined){
  token=gg.nextPageToken;
    sameurl=`https://youtube.googleapis.com/youtube/v3/playlists?key=AIzaSyCosfJ22WXpYAvaiSP62ER9TolvFEPOaLc&channelId=UCvjgXvBlbQiydffZU7m1_aw&pageToken=${token}&part=snippet`
    await go(sameurl);
}
  }
})
